...
import { SIDE_BAR_DESKTOP_ANCHOR, SIDE_BAR_MOBILE_ANCHOR, SIDE_BAR_WIDTH, TOP_BAR_DESKTOP_HEIGHT, TOP_BAR_MOBILE_HEIGHT } from "./config";
...
interface Props extends StackProps {
    ...
    title: string;
    variant: 'sidebarPersistentOnDesktop' | 'sidebarAlwaysTemporary' | 'sidebarAlwaysPersistent';
}
